...
//        else if(!INTEGER_CHARACTERS.matcher(password).find()) {
//            throw new InvalidPasswordException(2);
//        } else if(!SPECIAL_CHARACTERS.matcher(password).find()) {
//            throw new InvalidPasswordException(3);
//        } else if (!CAPITAL_CHARACTERS.matcher(password).find()) {
//            throw new InvalidPasswordException(4);
//        } else if (!LOWERCASE_CHARACTERS.matcher(password).find()) {
